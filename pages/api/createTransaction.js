...
const sellerAddress = 'AsdDSmkGBxRknLeoUaWoxi6TUXbCW4XJLibLSH37hYZf'
...
const createTransaction = async (req, res) => {
  console.log("req.body", req.body);
    try {
      ...
      // Were getting the mint address of the token we want to transfer 
      ...
      const transferInstruction = createTransferCheckedInstruction(
        ...
        usdcMint.decimals // THe token could have anyu number of decimals
      );
